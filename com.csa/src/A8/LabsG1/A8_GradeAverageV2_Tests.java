...
public class A8_GradeAverageV2_Tests {
    ...
    public void testIO2() throws Exception{
        ...
        A8.LabsG1.A9.CG1.A9.CG1.A10.L1.A12.L1.A12.L1.VideoStore.TestingOutputStream o = (A8.LabsG1.A9.CG1.A9.CG1.A10.L1.A12.L1.A12.L1.VideoStore.TestingOutputStream)System.out;
        Assert.assertEquals(unifyLineSeperators(expected), unifyLineSeperators(o.toString()));
    }*/
