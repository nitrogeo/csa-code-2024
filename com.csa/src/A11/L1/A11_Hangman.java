...
public class A11_Hangman {
    ...
    public boolean addGuessedLetter(char c) {
        ...
        /*
        2. Returns true if c has not been guessed yet and is contained in the sentence.
        3. The method returns false if c is a space, punctuation, or has already been guessed.
